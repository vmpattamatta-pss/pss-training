...
public class DivTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		ComplexNumber result = new Execute().div(firstNumber, secondNumber);
		int real = result.getReal();
		int imag = result.getImaginary();
		getJspContext().getOut().print("Division  of "+ ffirstpart + "+i" + fsecondPart+"&nbsp;&nbsp; and&nbsp;&nbsp;"+ sfirstpart + "+i" + ssecondpart);
