...
public class MulTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		ComplexNumber result = new Execute().mul(firstNumber, secondNumber);
		int real = result.getReal();
		int imag = result.getImaginary();
		getJspContext().getOut().print("multiplication of "+ ffirstpart + "+i" + fsecondPart+"&nbsp;&nbsp;and&nbsp;&nbsp;"+ sfirstpart + "+i" + ssecondpart);
