...
public class SubTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		ComplexNumber result = new Execute().sub(firstNumber, secondNumber);
		int real = result.getReal();
		int imag = result.getImaginary();
		getJspContext().getOut().print("substraction of "+ ffirstpart + "+i" + fsecondPart+"&nbsp;&nbsp;and&nbsp;&nbsp;"+ sfirstpart + "+i" + ssecondpart);
